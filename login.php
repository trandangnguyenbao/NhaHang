			...
			<div class="modal__inner">
				<div class="login">
					...
					<div class="grid">
						...
						?>
					<form class="login-container" action="login_submit.php" method="POST">
						<input type="email" name="Email" required="">
						<input type="password"  name="password" required="">
						<a href="index.php"><input type="submit" value="Submit" name="submit"></a>
					</form>
				...
				<ul>
					...
					<!-- google-->
						...
						<div class="bottom-text bottomtext">
							...
							<a href="../my_split/admin/update_user.php?id_user=<?php echo $rows['id_user']?>">Forgot your password?</a>
						</div>
					</div>
				</div>
			</div>
