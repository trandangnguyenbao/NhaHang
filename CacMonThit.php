	...
	<div id="body">
		<div class="content">
				...
				<div>
					...
					<?php
						...
						// Kết nối database tintuc
								...
								$result=mysqli_query($conn, "SELECT COUNT(id) as total FROM admin_category where maLH = '100'");
								...
								$result = mysqli_query($conn, "SELECT * FROM admin_category where maLH = '100' LIMIT $start, $limit");
								$i=0;
					...
					<ul>
						<li>
							<h2><a href="CacMonThit.php"><?php echo $row['tensp']?></a></h2>
							<p>
			...
			<?php
                    ...
                    echo '<button style = "height:30px;width:30px; background-color:white; color:black;"><a href="CacMonThit.php?page='.($current_page-1).'" style = "font-size:20px; color:black;text-decoration: none;font-weight: bolder;"><</a><button> ';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++){
                    ...
                    if ($i == $current_page){
                        ...
                        echo '<button style = "height:30px;width:30px; background-color:white; color:black;font-weight: bolder;"><a href="CacMonThit.php?page='.$i.'" style = "font-size:20px; color:black;text-decoration: none;" >'.$i.'</a> </button> ';
                    }
                }

                if ($current_page < $total_page && $total_page > 1){
                    echo '<button style = "height:30px;width:30px; background-color:white; color:black; font-weight: bolder;"><a href="CacMonThit.php?page='.($current_page+1).'" style = "font-size:20px; color:black;text-decoration: none;">></a></button> ';
                }
		...
		<div class="sidebar">
			...
			<ul class="navigation">
				<li class="first">
					<a class="active" href="CacMonThit.php">Các Món Thịt</a>
				</li>
				<li>
					<a href="HaiSan.php">Hải sản</a>
				</li>
				<li>
